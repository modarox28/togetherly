  ...
  return (
    ...
    >
      <div className="glass rounded-3xl border shadow-2xl overflow-hidden bg-white/90 dark:bg-night-800/60 border-black/5 dark:border-white/10 p-8">
        <h1 className="text-2xl font-bold text-day-900 dark:text-white mb-1">Create account</h1>
        <p className="text-sm text-day-900/40 dark:text-white/40 mb-6">Join Togetherly and watch together</p>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-4">
          ...
          <Button size="lg" className="w-full" type="submit" disabled={loading || !name || !email || !password}>
